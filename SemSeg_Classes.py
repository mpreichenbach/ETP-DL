...
from custom_losses import iou_loss, dice_loss, cc_iou_loss
...
vgg16_cc_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG16_cc/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG16_cc.csv', append=True)
]

vgg16_iou_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG16_iou/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG16_iou.csv', append=True)
]

vgg16_dice_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG16_dice/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG16_dice.csv', append=True)
]

vgg16_cc_iou_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG16_cc_iou/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG16_cc_iou.csv', append=True)
]

vgg19_cc_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG19_cc/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG19_cc.csv', append=True)
]

vgg19_iou_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG19_iou/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG19_iou.csv', append=True)
]

vgg19_dice_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG19_dice/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG19_dice.csv', append=True)
]

vgg19_cc_iou_callbacks = [
    TerminateOnNaN(),
    ModelCheckpoint(filepath='Saved Models/2021-08-11/VGG19_cc_iou/', saved_best_only=True, save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=10, min_delta=0.001),
    CSVLogger('Saved Models/2021-08-11/CSV logs/VGG19_cc_iou.csv', append=True)
]
